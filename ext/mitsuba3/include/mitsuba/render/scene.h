...
public:
    ...
    /// Return the list of bsdfs
    std::vector<ref<BSDF>> &bsdfs() { return m_bsdfs; }
    /// Return the list of sensors (const version)
    const std::vector<ref<BSDF>> &bsdfs() const { return m_bsdfs; }
    ...
    /// Get total variable parameters for the scene
