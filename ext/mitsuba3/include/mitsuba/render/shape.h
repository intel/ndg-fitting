...
public:
    ...
    const Vector3f rotation_axis() const { return m_rotation_axis; }

    const Float range_angle() const { return m_range_angle; }

    const Float min_angle() const { return m_min_angle; }
