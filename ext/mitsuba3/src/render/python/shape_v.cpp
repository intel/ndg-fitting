...
MI_PY_EXPORT(Shape) {
    ...
    auto shape = MI_PY_CLASS(Shape, Object)
        ...
        .def_method(Shape, min_bounds)
        .def_method(Shape, range_bounds)
        .def_method(Shape, rotation_axis)
        .def_method(Shape, min_angle)
        .def_method(Shape, range_angle)
        .def_method(Shape, num_parameters)
